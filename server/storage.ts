import { users, feedbacks, passwordResetTokens, type User, type InsertUser, type Feedback, type InsertFeedback, type PasswordResetToken, type InsertPasswordResetToken } from "@shared/schema";
import { db } from "./db";
